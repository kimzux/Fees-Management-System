...
@section('content')
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Check Payments</h1>
            </div>
            <hr class="sidebar-divider d-none d-md-block">
            <div class="card bg-light mb-3" style="max-width: 35rem;">
              <div class="card-header"><b>Check Payments</b></div>
              <div class="card-body">
                <form>
                    <div class="form-group row">
                        <label for="inputDate" class="col-sm-4 col-form-label"><b>From Date</b></label>
                        <div class="col-sm-6">
                          <input type="date" class="form-control" id="inputDate"  required>
                        </div>
                         </div>
                         <div class="form-group row">
                            <label for="inputDate" class="col-sm-4 col-form-label"><b>To Date</b></label>
                            <div class="col-sm-6">
                              <input type="date" class="form-control" id="inputDate"  required>
                            </div>
                             </div>
